...
from .views import RegisterView, profile_view, update_profile, archived_reservations_view, modify_reservation_view, cancel_reservation_view, verify_email, resend_verification_email, verify_email_reminder
